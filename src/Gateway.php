...
class Gateway extends AbstractGateway
{
     ...
     * Gateway name
     */
    const GATEWAY_NAME = 'IPara';

    /**
     * IPara gateway payment methods
     *
     * @var string
     */
    const IPARA_METHOD_CCVISAMC = 'CCVISAMC';
    const IPARA_METHOD_CCJCB = 'CCJCB';
    const IPARA_METHOD_CCDINERS = 'CCDINERS';
    const IPARA_METHOD_PAYPAL = 'PAYPAL';
    ...
    {
        return self::IPARA_METHOD_CCVISAMC;
    }
     ...
     * @return \Omnipay\IPara\Message\PurchaseRequest
     */
    public function purchase(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\IPara\Message\PurchaseRequest', $parameters);
    }
}
